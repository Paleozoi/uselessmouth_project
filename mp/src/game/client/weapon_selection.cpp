...
ConVar hud_fastswitch( "hud_fastswitch", "1", FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX | FCVAR_REPLICATED ); // NOTE(richard): I changed this, should probably make this REPPLICATED.
