...
#define DEFAULT_GRAVITY_STRING	"700" // NOTE(richard): I changed this, was 600.
#else
...
// NOTE(richard): Added || defined( HL2MP ) to all of them.
#if defined( DOD_DLL ) || defined( CSTRIKE_DLL ) || defined( HL1MP_DLL ) || defined( HL2MP )
...
#if defined( CSTRIKE_DLL ) || defined( HL1MP_DLL ) || defined( HL2MP )
